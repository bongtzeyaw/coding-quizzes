...
class TestReservationSystem < Minitest::Test
  ...
  def test_invalid_year
    assert_equal 'error', @reservation_system.check_reservation('A123', 1, '2023-01-01')
  end

  def test_invalid_month
    assert_equal 'error', @reservation_system.check_reservation('A123', 1, '2024-13-01')
  end
